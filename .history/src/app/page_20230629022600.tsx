...
export default function Home() {
	return (
		<main>
			...
			<div className='flex flex-col leading-loose text-sm mt-10 mb-3 text-gray-200'>
				<span>gonzagagianfrancesco@gmail.com</span>
				<span>+639196449757</span>
			</div>

			<div className=' flex gap-5'>
				<SocialIcon url="https://www.facebook.com/giangonzaga5947" network='facebook'  style={{ height: 32, width: 32 }}/>
				<SocialIcon url="https://www.instagram.com/gianfrncsco/" network='instagram'  style={{ height: 32, width: 32 }}/>
